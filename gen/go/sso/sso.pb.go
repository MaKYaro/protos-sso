...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // email that user uses to register
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password that user uses to register
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // Email that user used to login
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Password that user used to login
...
type LogoutRequest struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Token of logged in user who wants to logout
}
...
type LogoutResponse struct {
	...
	Success string `protobuf:"bytes,1,opt,name=success,proto3" json:"success,omitempty"` // Indicates whether the logout was successful
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,2,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates whether the user is an admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x16, 0x5a, 0x14, 0x6d, 0x61, 0x6b, 0x79, 0x61, 0x72,
	0x6f, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62, 0x06,
